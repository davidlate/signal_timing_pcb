...
#define RMT_TENS_PHASE_A_GPIO_NUM      20
#define RMT_TENS_PHASE_B_GPIO_NUM      21
...
void create_sine_wave(int32_t * waveform, double * waveform_double, int FREQUENCY) {
    ...
    for (int i = 0; i < WAVEFORM_LEN; i++) {
        ...
        // printf("Volume: %0.10f\n", volume);
        double sine_point = volume * sin(2 * 3.1415926 * FREQUENCY * timestep);  // Use 2 * PI for full sine wave cycle
